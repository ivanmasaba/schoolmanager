...
function showThis(str1, str2)
{
	...
	location.href = "http://localhost/school%20manager%20-%20copy/";
	/*var myClass = str1;
	var stream = str2;
	...
	url=url+"?class="+myClass+"&stream="+stream+"&subject="+subject+"&paper="+paper;
	url=url+"&sid="+Math.random();
	xmlHttp.open("GET",url,true);
	...
	{ 
		if (xmlHttp.readyState==4)
		{ 
			document.classResults.innerHTML = xmlHttp.responseText;
		}
	}
	xmlHttp.send(null);*/
}
